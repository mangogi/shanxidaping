$(function () {
    $.ajax({
        ...
        success: function (res) {
            ...
            var chart82 = echarts.init(document.getElementById('chart82'))
            var option82 ={
                title:{
                    text: '养老关系转入',
                    subtext: data[0].value + '人次' + '\n' + '20 %',
            ...
            chart82.setOption(option82)
            var data =  [
                {value: 20, name: '养老立户'},
                {value: 80, name: '未立户'},
               
            ]
            var chart83 = echarts.init(document.getElementById('chart83'))
            var option83 ={
                title:{
                    text: '养老关系转出',
                    subtext: data[0].value + '人次' + '\n' + '20 %',
            ...
            chart83.setOption(option83)
            var data =  [
                {value: 20, name: '养老立户'},
                {value: 80, name: '未立户'},
               
            ]
            var chart84 = echarts.init(document.getElementById('chart84'))
            var option84 ={
                title:{
                    text: '养老上账',
                    subtext: data[0].value + '人次' + '\n' + '20 %',
            ...
            chart84.setOption(option84)
            var data =  [
                {value: 20, name: '养老立户'},
                {value: 80, name: '未立户'},
               
            ]
            var chart85 = echarts.init(document.getElementById('chart85'))
            var option85 ={
                title:{
                    text: '养老退费',
                    subtext: data[0].value + '人次' + '\n' + '20 %',
            ...
            chart85.setOption(option85)
            var data =  [
                {value: 20, name: '养老立户'},
                {value: 80, name: '未立户'},
               
            ]
            var chart86 = echarts.init(document.getElementById('chart86'))
            var option86 ={
                title:{
                    text: '养老缴费',
                    subtext: data[0].value + '人次' + '\n' + '20 %',
